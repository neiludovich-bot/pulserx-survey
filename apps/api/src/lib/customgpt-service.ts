...
export async function askCustomGptForSurveyInterviewerTurn(input: {
  ...
  const prompt = [
    ...
    "Use approved BRUKINSA source material for factual/site/study detail and cite source-supported claims.",
    ...
    "When a source-supported numeric result is available, give the exact value instead of only saying results favored BRUKINSA, were strong, were positive, or were clinically meaningful.",
